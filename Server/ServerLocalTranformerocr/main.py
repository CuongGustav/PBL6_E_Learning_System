...
check_image_url = "https://datasendandreceiverserver.onrender.com/check_image"
...
def main():
    ...
    try:
        ...
        check_response = requests.post(check_image_url, json={"status": "success"})
        if check_response.status_code == 200:
            ...
            print(f"Lỗi khi gửi trạng thái: {check_response.status_code} - {check_response.text}")
